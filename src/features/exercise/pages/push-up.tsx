...
import { ExerciseCompletionDialog } from "../components/exercise-completion-dialog";
...
import { useExerciseCompletionCooldown } from "../use-exercise-completion-cooldown";
...
export default function Page() {
  ...
  const cooldown = useExerciseCompletionCooldown({
    pause,
    sessionReps,
  });
  ...
  return (
    ...
    >
      ...
      <ExerciseInitializationDialog
        ...
        isOpen={!cooldown.isCooldownActive && (!isLoaded || cameraError !== null)}
      />

      {cooldown.isCooldownActive && (
        <ExerciseCompletionDialog
          countdown={cooldown.countdown}
          onRenew={cooldown.onRenew}
          remainingCooldownMs={cooldown.remainingCooldownMs}
          renewButtonRef={cooldown.renewButtonRef}
        />
      )}
    </section>
  );
